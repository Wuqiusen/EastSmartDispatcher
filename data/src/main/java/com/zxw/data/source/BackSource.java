...
public class BackSource {
    ...
    public void loadBack(Subscriber<List<BackHistory>> subscriber, String code, int lineId, int stationId, String keyCode, int pageNo, int pageSize){
        HttpMethods.getInstance().backHistory(subscriber, code, lineId, stationId, keyCode, pageNo, pageSize);
    }
}
